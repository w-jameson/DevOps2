...
# From chapter 6 setup of app and docker
load_dotenv(find_dotenv())

b = pins.board_folder('data/model', allow_pickle_read=True)
v = VetiverModel.from_pin(b, 'penguin_model', version = '20240313T141647Z-fdb5a')

vetiver_api = vetiver.VetiverAPI(v)
api = vetiver_api.app


#Began with chapter 3 and continued into 4 and 6
